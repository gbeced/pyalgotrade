...
from pyalgotrade.constants.Constants import *
...
class Feed(csvfeed.GenericBarFeed):
    ...
    def __init__(self, frequency=bar.Frequency.DAY, timezone=None, maxLen=None):
        ...
        self.setDateTimeFormat(NSE_DATE_FORMAT)
        columnNames = {
            "datetime": "Date",
            "open": "Open Price",
            "high": "High Price",
        ...
        extraCols= {    "prev_close": "Prev Close Price",
            "52week_high": "52 Week High Price",
            "52week_low": "52 Week Low Price",
            "vwap": "VWAP"
        }
        for key,val in columnNames.items():
            self.setColumnName(key,val)
